...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        De esta forma se puede implementar una instancia de film, después de ser una clase Abstracta
        Film film = new Movie("", "", "", 1, (short) 1999);
        film.view(); //Hace lo definido en movie

        Film film1 = new Chapter("", "", "", 30, (short) 1999, 20, "");
