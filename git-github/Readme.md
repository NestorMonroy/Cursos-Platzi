...
|git reflog|guarda todos los cambios aunque decidas borrarlos|
...
git reset --soft #IDCOMMIT # Te recuperará todos los cambios que tengas diferentes al commit #IDCOMMIT, los agregará al staging area y moverá el head al commit #IDCOMMIT
...
¿Cómo instalas Gitk?
R=Se instala automáticamente en Windows y MacOS

Es mejor aprender a manejar Git con la terminal antes de hacerlo con herramientas visuales como Gitk porque:
R=Debemos aprender Git con sus comandos de la terminal para resolver problemas o conflictos más avanzados. Gitk funciona , pero no nos permite realizar operaciones tan complejas.
