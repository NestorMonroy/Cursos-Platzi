...
public class PureFunctions {
    /**
     * Aunque hoy dia conocemos a los métodos estáticos como métodos de clase o simplemente métodos estáticos,
     * en realidad un método puede ser considerado o visto como una función.
     * <p>
     * Basándonos en nuestra definición de función, sabemos que para cada X genera una Y. En este caso,
